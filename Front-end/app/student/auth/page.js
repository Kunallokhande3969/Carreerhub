...
import { FiCheckCircle, FiArrowRight, FiBriefcase, FiClock } from "react-icons/fi";
import {
...
const Page = () => {
  ...
  const uniqueJobs = Array.isArray(jobs) 
    ? jobs.filter((job, index, self) => index === self.findIndex((j) => j._id === job._id))
    : [];

  const uniqueInternships = Array.isArray(internships)
    ? internships.filter((internship, index, self) => 
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
              ...
              >
                <div className="p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-500 mb-1">Skills Required:</p>
      ...
      <section>
        <div className="flex items-center gap-4 mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-800">
            Available Internships for <span className="text-purple-600">{student?.firstname}</span>
          </h2>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {uniqueInternships.map((internship) => (
              ...
              >
                <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <h3 className="text-xl font-bold text-gray-800">{internship.profile}</h3>
